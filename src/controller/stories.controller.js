...
exports.createStory = async (req, res) => {
    try {
        const { title, description, author_id, link_forum } = req.body;
        ...
        const [result] = await pool.query(
            "INSERT INTO Stories (title,  description, author_id, urlImg , link_forum) VALUES (?, ?, ? , ?,?)",
            [title, description, author_id, coverUrl, link_forum]
        );
